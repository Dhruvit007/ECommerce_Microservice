...
namespace UserService.API.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(ApiResponse<ForgotPasswordResponseDTO>), (int)HttpStatusCode.OK)]
        [ProducesResponseType(typeof(ApiResponse<string>), (int)HttpStatusCode.BadRequest)]
        ...
        [ProducesResponseType(typeof(ApiResponse<IEnumerable<AddressDTO>>), 200)]
        [ProducesResponseType(typeof(ApiResponse<string>), (int)HttpStatusCode.NotFound)]
