...
namespace OrderService.Domain.Repositories
{
    public interface IMasterDataRepository
    {
        ...
        Task<List<CancellationPolicy>> GetActiveCancellationPoliciesAsync(DateTime asOfDate);

        Task<List<ReturnPolicy>> GetReturnPoliciesAsync();
        Task<ReturnPolicy?> GetReturnPolicyByIdAsync(int id);
        Task<List<ReturnPolicy>> GetActiveReturnPoliciesAsync(DateTime asOfDate);
